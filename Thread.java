...
public class Thread extends java.lang.Thread implements Runnable {
    ...
    int len;            // len of map (len x len) == heatmap dimensions
    double map[][];     // Heatmap
    ...
    public void run() {
        ...
        try {
            do {
                ...
                barrier.await();
                System.out.println(Thread.currentThread().getName() + " : " + barrier.getNumberWaiting());

            } while ( (totalError[0] + totalError[1] + totalError[2] + totalError[3] + totalError[4] + totalError [5] + totalError[6] + totalError[7]) > 5 );
            ...
            System.out.println(Thread.currentThread().getName() + " over here ");
            System.out.println(barrier.getParties());
            barrier.reset();
